const obj = [
    ...
    },
    {
        ...
        "codeAfterQuestion": "let modal = document.querySelector('#result');setTimeout(function () { modal.classList.remove('hidden');}, 10000);console.log('Results shown');",
        "answers": [
            {
    ...
    },
    {
        ...
        "codeAfterQuestion": "class Animal { static belly = []; eat() { Animal.belly.push('food'); }}let a = new Animal();a.eat();console.log(/* Snippet Here */); //Prints food",
        "answers": [
            {
    ...
    },
    {
        ...
        "answers": [
            {
                "answer": "`A`",
                "codeAfterAnswer": "```jsfor (var i = 1; i <= 4; i++) { setTimeout(function () { console.log(i); }, i * 10000);}```",
                "isCorrectAnswer": false
            },
            {
                "answer": "`B`",
                "codeAfterAnswer": "```jsfor (var i = 1; i <= 4; i++) { (function (i) { setTimeout(function () { console.log(j); }, j * 1000); })(j);}```",
                "isCorrectAnswer": false
            },
            {
                "answer": "`C`",
                "codeAfterAnswer": "```jsfor (var i = 1; i <= 4; i++) { setTimeout(function () { console.log(i); }, i * 1000);}```",
                "isCorrectAnswer": false
            },
            {
                "answer": "`D`",
                "codeAfterAnswer": "```jsfor (var i = 1; i <= 4; i++) { (function (j) { setTimeout(function () { console.log(j); }, j * 1000); })(i);}```",
                "isCorrectAnswer": true
            },
            {
                "answer": "`E`",
                "codeAfterAnswer": "```jsfor (var j = 1; j <= 4; j++) { setTimeout(function () { console.log(j); }, j * 1000);}```1. ",
                "isCorrectAnswer": false
            }
        ],
        "reference": [
    ...
    },
    {
        ...
        "answers": [
            {
                "answer": "`A`",
                "codeAfterAnswer": "```jslet discountPrice = function (price) { return price * 0.85;};```",
                "isCorrectAnswer": true
            },
            {
                "answer": "`B`",
                "codeAfterAnswer": "```jslet discountPrice(price) { return price * 0.85;};```",
                "isCorrectAnswer": false
            },
            {
                "answer": "`C`",
                "codeAfterAnswer": "```jslet function = discountPrice(price) { return price * 0.85;};```",
                "isCorrectAnswer": false
            },
            {
                "answer": "`D`",
                "codeAfterAnswer": "```jsdiscountPrice = function (price) { return price * 0.85;};```",
                "isCorrectAnswer": true
            }
        ],
        "reference": [
    ...
    },
    {
        ...
        "codeAfterQuestion": "var Storm = function () {};Storm.prototype.precip = 'rain';var WinterStorm = function () {};WinterStorm.prototype = new Storm();WinterStorm.prototype.precip = 'snow';var bob = new WinterStorm();console.log(bob.precip);",
        "answers": [
            {
                "answer": "Storm()",
                "codeAfterAnswer": null,
    ...
    },
    {
        ...
        "codeAfterQuestion": "'use strict';function logThis() { this.desc = 'logger'; console.log(this);}new logThis();",
        "answers": [
            {
                "answer": "`undefined`",
                "codeAfterAnswer": null,
    ...
    },
    {
        ...
        "codeAfterQuestion": "let roadTypes = ['street', 'road', 'avenue', 'circle'];",
        "answers": [
            {
                "answer": "roadTypes.2",
                "codeAfterAnswer": null,
    ...
    },
    {
        ...
        "codeAfterQuestion":"function addNumbers(x, y) { if (isNaN(x) || isNaN(y)) { }}",
        "answers":[
            {
    ...
    },
    {
        ...
        "question":" Q20. What would be the result in the console of running this code?",
    ...
    },
    {
        ...
        "codeAfterQuestion":"var a = ['dog', 'cat', 'hen'];a[100] = 'fox';console.log(a.length);",
        "answers":[
            {
                "answer":"101",
                "codeAfterAnswer":null,
    ...
    },
    {
        ...
        "answers":[
            ...
            {
                "answer":"You can access values in a Map without iterating over the whole collection.**Explanation:** `Map.prototype.size returns the number of elements in a Map, whereas Object does not have a built-in method to return its size.`",
                "codeAfterAnswer":null,
                "isCorrectAnswer":false
            }
        ],
    ...
    },
    {
        ...
        "question":" Q24. What is the value of dessert.type after executing this code?",
        "codeAfterQuestion":"const dessert = { type: 'pie' };dessert.type = 'pudding';",
        "answers":[
            {
                "answer":"pie",
                "codeAfterAnswer":null,
    ...
    },
    {
        ...
        "question":" Q33. For the following class, how do you get the value of 42 from an instance of X?",
    ...
    },
    {
        ...
        "codeAfterQuestion":"sum(10, 20);diff(10, 20);function sum(x, y) { return x + y;}let diff = function (x, y) { return x - y;};",
        "answers":[
            {
    ...
    },
    {
        ...
        "question":" Q37. How do you import the lodash library making it top-level Api available as the  variable?",
    "codeAfterQuestion":null,
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"var v = 1;var f1 = function () { console.log(v);};var f2 = function () { var v = 2; f1();};f2();",
    "answers":[
    {
        "answer":"2",
        "codeAfterAnswer":null,
...
},
{
    ...
    {
        "answer":"You are calling a method named reduce on an object that's has a null value.**Explanation**: `You cannot invoke reduce on undefined object... It will throw (yourObject is not Defined...)`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    }
],
...
},
{
    ...
    "question":" Q43. How many prototype objects are in the chain for the following array?`let arr = [];`",
    "codeAfterQuestion":null,
    "answers":[
    {
        "answer":"3",
...
},
{
    ...
    "question":" Q45. What type of scope does the end variable have in the code shown?",
...
},
{
    ...
    "question": "Q50. Which statement references the DOM node created by the code shown? ```html <p class=\"pull\">lorem ipsum</p>```",
    "codeAfterQuestion":null,
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"let answer = true;if (answer === false) { return 0;} else { return 10;}",
    "answers":[
    {
        "answer":"10",
        "codeAfterAnswer":null,
...
},
{
    ...
    "question":" Q52. What is the result in the console of running the code shown?",
    "codeAfterQuestion":"var start = 1;function setEnd() { var end = 10;}setEnd();console.log(end);",
    "answers":[
    {
        "answer":"10",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"function sayHello() { console.log('hello');}console.log(sayHello.prototype);",
    "answers":[
    {
        "answer":"undefined",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"function printA() { console.log(answer); var answer = 1;}printA();printA();",
    "answers":[
    {
        "answer":"`1` then `1`",
        "codeAfterAnswer":null,
...
},
{
    ...
    "question":" Q70. You've written the event listener shown below for a form button, but each time you click the button, the page reloads. Which statement would stop this from happening?",
    "codeAfterQuestion":"button.addEventListener( 'click', function (e) { button.className = 'clicked'; }, false,);",
    "answers":[
    {
...
},
{
    ...
    "question":" Q77. Which class-based component is equivalent to this function component?",
    ...
    {
        "answer":"`class Greeting extends React.Component { constructor() { return <h1>Hello {this.props.name}!</h1>; } }`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    },
    {
        "answer":"`class Greeting extends React.Component { <h>Hello {this.props.name}!</h>; } }`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    },
    {
        "answer":"`class Greeting extends React.Component { render({ name }) { return <h1>Hello {name}!</h1>; } }`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    }
],
...
},
{
    ...
    "question":" Q78. Which class-based lifecycle method would be called at the same time as this effect Hook?",
...
},
{
    ...
    "question":" Q80. How would you use the TaxCalculator to determine the amount of tax on \$50?",
    "codeAfterQuestion":"class TaxCalculator { static calculate(total) { return total * 0.05; }}",
    "answers":[
    {
        "answer":"calculate(50);",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"const foo = { bar() { console.log('Hello, world!'); }, name: 'Albert', age: 26,};",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"console.log('I');setTimeout(() => { console.log('love');}, 0);console.log('Javascript!');",
    "answers":[
    {
    ...
    {
        "answer":"The output may change with each execution of code and cannot be determined.",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    },
    {
...
},
{
    ...
    {
        "answer":"The `forEach()` methods returns a new array with a transformation applied on each item in the original array, whereas the `map()` method iterates through an array with no return value.1. ",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    }
],
...
},
{
    ...
    "codeAfterQuestion":"function makeAdder(x) { return function (y) { return x + y; };}var addFive = makeAdder(5);console.log(addFive(3));",
    "answers":[
    {
        "answer":"overloading",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"let rainForests = ['Amazon', 'Borneo', 'Cerrado', 'Congo'];rainForests.splice(0, 2);console.log(rainForests);",
    "answers":[
    {
...
},
{
    ...
    "question":" Q91. Which missing line would allow you to create five variables(one,two,three,four,five) that correspond to their numerical values (1,2,3,4,5)?",
...
},
{
    ...
    "codeAfterQuestion":"const obj = { a: 1, b: 2, c: 3,};const obj2 = { ...obj, a: 0,};console.log(obj2.a, obj2.b);",
    "answers":[
    {
...
},
{
    ...
    "question":" Q93. Which line could you add to this code to print \"jaguar\" to the console?",
    "codeAfterQuestion":"let animals = ['jaguar', 'eagle'];//Missing Lineconsole.log(animals.pop()); //Prints jaguar",
    "answers":[
    {
    ...
    {
        "answer":"`animals.pop();`**Note:** `this question has two correct answers.`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":true
    }
],
...
},
{
    ...
    "codeAfterQuestion":"//Missing Linefor (var i = 0; i < vowels.length; i++) { console.log(vowels[i]); //Each letter printed on a separate line as follows; //a //e //i //o //u}",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"const x = 6 % 2;const y = x ? 'One' : 'Two';console.log(y);",
    "answers":[
    {
        "answer":"undefined",
        "codeAfterAnswer":null,
...
},
{
    ...
    "question":" Q96. How would you access the word It from this multidimensional array?`let matrix = [[\"You\",\"Can\"],[\"Do\",\"It\"],[\"!\",\"!\",\"!\"]];`",
    "codeAfterQuestion":null,
    "answers":[
    {
        "answer":"`matrix[1[2]]`",
...
},
{
    ...
    "codeAfterQuestion":"const animals = ['Rabbit', 'Dog', 'Cat'];animals.unshift('Lizard');",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"var sound = 'grunt';var bear = { sound: 'roar' };function roar() { console.log(this.sound);}",
    "answers":[
    {
...
},
{
    ...
    "question":" Q102. Which statement correctly imports this code from some-file.js?",
    "codeAfterQuestion":"//some-file.jsexport const printMe = (str) => console.log(str);",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"const arr1 = [2, 4, 6];const arr2 = [3, 5, 7];console.log([...arr1, ...arr2]);",
    "answers":[
    {
        "answer":"`[2, 3, 4, 5, 6, 7]`",
        "codeAfterAnswer":null,
...
},
{
    ...
    "question":" Q108. What is the output that is printed when the div containing the text \"Click Here\" is clicked?```html//HTML Markup<div id=\"A\"> <div id=\"B\"> <div id=\"C\">Click Here</div> </div></div>```",
    "codeAfterQuestion":"//JavaScriptdocument.querySelectorAll('div').forEach((e) => { e.onclick = (e) => console.log(e.currentTarget.id);});",
    "answers":[
    {
        "answer":"C B A",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"const myNumbers = [1, 2, 3, 4, 5, 6, 7];const myFunction = (arr) => { return arr.map((x) => x + 3).filter((x) => x < 7);};console.log(myFunction(myNumbers));",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"let rainForestAcres = 10;let animals = 0;while (rainForestAcres < 13 || animals <= 2) { rainForestAcres++; animals += 2;}console.log(animals);",
    "answers":[
    {
        "answer":"2",
        "codeAfterAnswer":null,
...
},
{
    ...
    "question":" Q111. Which snippet could you add to this code to print \"YOU GOT THIS\" to the console?",
    "codeAfterQuestion":"let cipherText = [...'YZOGUT QGMORTZ MTRHTILS'];let plainText = '';/* Missing Snippet */console.log(plainText); //Prints YOU GOT THIS",
    "answers":[
    {
        "answer":"A",
        "codeAfterAnswer":"```jsfor (let key of cipherText.keys()) { plainText += key % 2 === 0 ? key : ' ';}```",
        "isCorrectAnswer":false
    },
    {
        "answer":"B",
        "codeAfterAnswer":"```jsfor (let [index, value] of cipherText.entries()) { plainText += index % 2 !== 0 ? value : '';}```",
        "isCorrectAnswer":false
    },
    {
        "answer":"C",
    ...
    {
        "answer":"D",
        "codeAfterAnswer":"```jsfor (let value of cipherText) { plainText += value;}```1. ",
        "isCorrectAnswer":false
    }
],
    "reference":[
...
},
{
    ...
    "codeAfterQuestion":"var pokedex = ['Snorlax', 'Jigglypuff', 'Charmander', 'Squirtle'];pokedex.pop();console.log(pokedex.pop());",
    "answers":[
    {
        "answer":"Charmander",
        "codeAfterAnswer":null,
    ...
    {
        "answer":"Squirtle**Explanation**: `The pop() method removes the last element from an array and returns that element. This method changes the length of the array.`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    }
],
...
},
{
    ...
    "question":" Q115. What line of code causes this code segment to throw an error?",
    "codeAfterQuestion":"const lion = 1;let tiger = 2;var bear;++lion;bear += lion + tiger;tiger++;",
    "answers":[
    {
    ...
    {
        "answer":"`line 6, because the += operator cannot be used with the undefined variable bear`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    },
    {
        "answer":"`line 5, because the prefix (++) operator does not exist in JavaScript`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    },
    {
...
},
{
    ...
    "question":" Q116. What will be the value of `result` after running this code?",
    "codeAfterQuestion":"const person = { name: 'Dave', age: 40, hairColor: 'blue' };const result = Object.keys(person).map((x) => x.toUpperCase());",
    "answers":[
    {
...
},
{
    ...
    "question":" Q117. Which snippet could you insert to this code to print \"swim\" to the console?",
    "codeAfterQuestion":"let animals = [\"eagle\", \"osprey\", \"salmon\"];let key = animal => animal === \"salmon\";if(/* Insert Snippet Here */){ console.log(\"swim\");}",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"class RainForest { static minimumRainFall = 60;}let congo = new RainForest();RainForest.minimumRainFall = 80;console.log(congo.minimumRainFall);",
    "answers":[
    {
        "answer":"`undefined`",
        "codeAfterAnswer":null,
    ...
    {
        "answer":"`None of these answers, as static is not a feature in Javascript.`",
        "codeAfterAnswer":null,
        "isCorrectAnswer":false
    },
    {
...
},
{
    ...
    "question":" Q119. How can you attempt to access the property `a.b` on `obj` without throwing an error if a is undefined?",
...
},
{
    ...
    "codeAfterQuestion":"if (true) { var x = 5; const y = 6; let z = 7;}console.log(x + y + z);",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"const x = [1, 2];const y = [5, 7];const z = [...x, ...y];console.log(z);",
    "answers":[
    {
        "answer":"`[1,2,5,7]`",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"let scores = [];scores.push(1, 2);scores.pop();scores.push(3, 4);scores.pop();score = scores.reduce((a, b) => a + b);console.log(score);",
    "answers":[
    {
        "answer":"`3`",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"let bear = { sound: 'roar', roar() { console.log(this.sound); },};bear.sound = 'grunt';let bearSound = bear.roar;bearSound();",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"var cat = { name: 'Athena' };function swap(feline) { feline.name = 'Wild'; feline = { name: 'Tabby' };}swap(cat);console.log(cat.name);",
    "answers":[
    {
        "answer":"undefined",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"var thing;let func = (str = 'no arg') => { console.log(str);};func(thing);func(null);",
    "answers":[
    {
        "answer":"null no arg",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"const myFunc = () => { const a = 2; return () => console.log('a is ' + a);};const a = 1;const test = myFunc();test();",
    "answers":[
    {
        "answer":"a is 1",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"const myFunc = (num1, num2 = 2, num3 = 2) => { return num1 + num2 + num3;};let values = [1, 5];const test = myFunc(2, ...values);console.log(test);",
    "answers":[
    {
        "answer":"8",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"var flagsJSON = '{ \"countries\" : [' + '{ \"country\":\"Ireland\" , \"flag\":\"ð��®ð��ª\" },' + '{ \"country\":\"Serbia\" , \"flag\":\"U+1F1F7 U+1F1F8\" },' + '{ \"country\":\"Peru\" , \"flag\":\"ð��µð��ª\" } ]}';var flagDatabase = JSON.parse(flagsJSON);",
    "answers":[
    {
...
},
{
    ...
    "question":" Q131. Which snippet allows the acresOfRainForest variable to increase?",
    "codeAfterQuestion":"let conservation = true;let deforestation = false;let acresOfRainForest = 100;if (/* Snipped goes here */){ ++acresOfRainForest;}",
    "answers":[
    {
...
},
{
    ...
    "question":" Q136. What value is printed to the console after this code execute?",
    "codeAfterQuestion":"let cat = Object.create({ type: 'lion' });cat.size = 'large';let copyCat = { ...cat };cat.type = 'tiger';console.log(copyCat.type, copyCat.size);",
    "answers":[
    {
        "answer":"tiger large",
        "codeAfterAnswer":null,
...
},
{
    ...
    "codeAfterQuestion":"let animals = [{ type: 'lion' }, 'tiger'];let clones = animals.slice();clones[0].type = 'bear';clones[1] = 'sheep';console.log(animals[0].type, clones[0].type);console.log(animals[1], clones[1]);",
    "answers":[
    {
...
},
{
    ...
    "question":" Q139. Which snippet could you add to this code to print \"{\"type\": \"tiger\"}\" to the console?",
    "codeAfterQuestion": "let cat = { type: \"tiger\", size: \"large\" };let json = /* Snippet here */;console.log(json); // print {\"type\":\"tiger\"}",
    "answers":[
    {
...
},
{
    ...
    "question": " Q141. In JavaScript, all objects inherit a built-in property from a **\\*\\*\\*\\***\\_\\_\\_**\\*\\*\\*\\***.",
    "codeAfterQuestion":null,
    "answers":[
    {
        "answer":"node",
...
},
{
    ...
    "question":" Q142. Which of the following are not server-side Javascript objects?",
    "codeAfterQuestion":null,
    "answers":[
    {
        "answer":"Date",
...
},
{
    ...
    "codeAfterQuestion":"const obj1 = { first: 20, second: 30, first: 50 };console.log(obj1);",
    "answers":[
    {
...
},
{
    ...
    "codeAfterQuestion":"<script type=\"text/javascript\">a = 5 + \"9\"; document.write(a);</script>",
    "answers":[
    {
...
},
{
    ...
    "question":" Q150. What value is assigned to total after this code executes?",
    "codeAfterQuestion":"function sum(num1, num2 = 2, num3 = 3) { return num1 + num2 + num3;}let values = [1, 5];let total = sum(4, ...values);",
    "answers":[
    {
        "answer":"10",
        "codeAfterAnswer":null,
...
},
{
    ...
    "question":" Q151. Which statement is applicable to the defer attribute of the HTML <script> tag?",
    "codeAfterQuestion":null,
    "answers":[
    {
...
},
{
    ...
    "question":" Q152. Which method of a class is called to initialize an object of that class?",
    "codeAfterQuestion":null,
    "answers":[
    {
        "answer":"init()",
...
},
{
    ...
    "question":" Q154. How would you check if the word \"pot\" is in the word \"potato\"?",
    "codeAfterQuestion":null,
    "answers":[
    {
...
},
{
    ...
    "question":" Q155. Which collection object allows a unique value to be inserted only once?",
    "codeAfterQuestion":null,
    "answers":[
    {
        "answer":"Map",
